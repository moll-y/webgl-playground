import vshader from "@glsl/4.3/shader.vert";
import fshader from "@glsl/4.3/shader.frag";
import { getWebGL2RenderingContext } from "@/utils";
import { Shader } from "@/shader";

function main() {
  const gl = getWebGL2RenderingContext("4.3");
  ...
  gl.bufferData(
    gl.ARRAY_BUFFER,
    new Float32Array([
      0.5, 0.5, 0, 1, 1, 0, 0, 1, 2, 2, 0.5, -0.5, 0, 1, 0, 1, 0, 1, 2, 0, -0.5,
      -0.5, 0, 1, 0, 0, 1, 1, 0, 0, -0.5, 0.5, 0, 1, 1, 1, 0, 1, 0, 2,
    ]),
    gl.STATIC_DRAW,
  );
  gl.bufferData(
