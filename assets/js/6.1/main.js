import vshader from "@glsl/6.1/shader.vert";
import fshader from "@glsl/6.1/shader.frag";
import { getWebGL2RenderingContext } from "@/utils";
import { Shader } from "@/shader";
import { glMatrix, mat4 } from "gl-matrix";

function main() {
  const gl = getWebGL2RenderingContext("6.1");
  ...
  function render() {
    ...
    mat4.fromRotation(model, glMatrix.toRadian(-55), [1, 0, 0]);
