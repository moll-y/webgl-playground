import vshader from "@glsl/7.3/shader.vert";
import fshader from "@glsl/7.3/shader.frag";
import { getWebGLRenderingContext, loadTexture } from "@/utils";
import { Shader } from "@/shader";
import { glMatrix, mat4, vec3 } from "gl-matrix";

function main() {
  const [gl, canvas] = getWebGLRenderingContext("7.3");
  ...
  canvas.onwheel = function (event) {
    ...
    fov = Math.max(1, Math.min(45, fov));
  };
